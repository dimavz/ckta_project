...
<div class="contact<?php echo $this->pageclass_sfx?>">
	...
	<?php if ($this->params->get('presentation_style') == 'tabs'):?>
		<ul class="nav nav-tabs" id="contact-tab-head">
				<?php if ($showform) : ?><li class="active"><a data-toggle="tab" href="#display-form"><?php echo JText::_('COM_CONTACT_EMAIL_FORM'); ?></a></li><?php endif; ?>
				<?php if ($showlinks) : ?><li<?php echo $activehead == 'display-links' ? ' class="active"' : '' ?>><a data-toggle="tab" href="#display-links"><?php echo JText::_('COM_CONTACT_LINKS'); ?></a></li><?php endif; ?>
				<?php if ($showarticles) : ?><li<?php echo $activehead == 'display-articles' ? ' class="active"' : '' ?>><a data-toggle="tab" href="#display-articles"><?php echo JText::_('JGLOBAL_ARTICLES'); ?></a></li><?php endif; ?>
				<?php if ($showprofile) : ?><li<?php echo $activehead == 'display-profile' ? ' class="active"' : '' ?>><a data-toggle="tab" href="#display-profile"><?php echo JText::_('COM_CONTACT_PROFILE'); ?></a></li><?php endif; ?>
				<?php if ($showmisc) : ?><li<?php echo $activehead == 'display-misc' ? ' class="active"' : '' ?>><a data-toggle="tab" href="#display-misc"><?php echo JText::_('COM_CONTACT_OTHER_INFORMATION'); ?></a></li><?php endif; ?>
				<li<?php echo $activehead == 'basic-details' ? ' class="active"' : '' ?>><a data-toggle="tab" href="#basic-details"><?php echo JText::_('COM_CONTACT_DETAILS'); ?></a></li>
		</ul>
