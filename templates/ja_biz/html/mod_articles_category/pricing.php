				...
				<li class="clearfix<?php echo $jaliclass;?>">
					...
					<div class="footer-feature clearfix">
						...
						<p class="mod-articles-category-readmore">
							<a class="mod-articles-category-title btn-pricing<?php echo $item->active; ?>" href="<?php echo $item->link; ?>">
								<?php if ($item->params->get('access-view')== FALSE) :
									echo JText::_('JA_PRICING_MOD_ARTICLES_CATEGORY_REGISTER_TO_READ_MORE');
								...
								elseif ($params->get('show_readmore_title', 0) == 0) :
									echo JText::sprintf('JA_PRICING_MOD_ARTICLES_CATEGORY_READ_MORE_TITLE');
								else :

									echo JText::_('JA_PRICING_MOD_ARTICLES_CATEGORY_READ_MORE');
									echo JHtml::_('string.truncate', ($item->title), $params->get('readmore_limit'));
								endif; ?>
							</a>
						</p>
	    ...
	    <li class="clearfix<?php echo $jaliclass;?>">
			...
			<div class="tabs-category clearfix">
				...
				<div class="footer-feature clearfix">
					...
					<?php if ($params->get('show_readmore')) :?>
					<p class="mod-articles-category-readmore">
						<a class="mod-articles-category-title btn-orange <?php echo $item->active; ?>" href="<?php echo $item->link; ?>">
						<?php if ($item->params->get('access-view')== FALSE) :
								echo JText::_('JA_PRICING_MOD_ARTICLES_CATEGORY_REGISTER_TO_READ_MORE');
							elseif ($readmore = $item->alternative_readmore) :
								echo $readmore;
