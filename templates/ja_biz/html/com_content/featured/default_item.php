...
<div class="system-unpublished">
	...
	<article>
		...
		<?php endif ?>
			...
			<?php if ($params->get('show_readmore') && $this->item->readmore) :
				...
				<section class="readmore">
					<a class="btn btn-default button btn-primary" href="<?php echo $link; ?>">
						<span>
		...
		<?php if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
			...
			<div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image article-image article-image-intro col-md-6">
				<img
